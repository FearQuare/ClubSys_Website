        ...
        <form onSubmit={handleSubmit} className="w-full max-w-md space-y-4">
          ...
          <div>
            <input
              ...
              required
              className="bg-gradient-to-br from-gray-600 to-gray-900 bg-blend-lighten text-white mt-1 block w-full px-3 py-3 border border-color4 rounded-full shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
              value={password}
